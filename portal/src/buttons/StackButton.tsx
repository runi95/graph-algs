function StackButton(props: {isActive: boolean}) {
  return (
    <svg version='1.1' xmlns='http://www.w3.org/2000/svg' xmlnsXlink='http://www.w3.org/1999/xlink' width='100%' height='100%' viewBox='0 0 512 512' xmlSpace='preserve'>
      <g color={props.isActive ? '#48c' : '#555'}>
        <rect stroke={props.isActive ? '#7bf' : '#888'} strokeWidth='24' fill='currentcolor' x='176' y='20' width='160' height='160' />
        <rect stroke={props.isActive ? '#7bf' : '#888'} strokeWidth='24' fill='currentcolor' x='176' y='230' width='160' height='160' />
